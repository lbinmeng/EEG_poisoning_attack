...
for poison_num in poison_nums:
    ...
    print(
        'poisoning number {}: acc={}, bca={}, poison_rate={}'.format(poison_num, acc_mean / s_train, bca_mean / s_train,
                                                                     poison_rate_mean / s_train))
    accs.append(acc_mean / s_train)
    bcas.append(bca_mean / s_train)
    poison_rates.append(poison_rate_mean / s_train)

print('accs:', accs)
print('bcas:', bcas)
print('poison rates:', poison_rates)
np.savez('poisoning_number_' + key + '.npz', poison_nums=poison_nums, accs=accs, bcas=bcas, poison_rates=poison_rates)
